...
function OAuth2Strategy(options, verify) {
  ...
  //this.defaultOauth2Options = {clientID: options.clientID,  clientSecret: options.clientSecret,'', authorizationURL: options.authorizationURL, tokenURL: options.tokenURL, customHeaders: options.customHeaders};
...
OAuth2Strategy.prototype.authenticate = function(req, options) {
  ...
  this._oauth2 = new OAuth2(options.clientID,  null,
